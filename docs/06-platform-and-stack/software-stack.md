...
| Media plane | LiveKit WebRTC SFU adapter with one unified audio/video call lifecycle, source-restricted grants, screen sharing, and durable expiry/participant eviction | Unit/browser/live same-host direct and group media journeys, deployment preflight, and [production two-party cellular audio/video qualification](../11-testing-and-quality/external-media-qualification-2026-07-27.md) | Managed-cloud production WSS/ICE/UDP and two-party cellular audio/video qualified; forced TURN/TLS, group/bandwidth capacity, external screen share, privacy, outage, and incident evidence remain pending |
