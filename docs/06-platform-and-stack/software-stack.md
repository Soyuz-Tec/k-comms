...
| Media plane | LiveKit WebRTC SFU adapter with one unified audio/video call lifecycle, source-restricted grants, screen sharing, and durable expiry/participant eviction | Unit/browser/live same-host direct and group media journeys plus deployment preflight | Implemented local Compose baseline; production WSS/HTTPS, TURN/TLS, group/bandwidth capacity, privacy, outage, and incident evidence remain pending |
