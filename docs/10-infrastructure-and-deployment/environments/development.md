...
Document account/project boundaries, regions and zones, network ranges, runtime sizing, database class, backup policy, secrets, observability retention, deployment authority, data policy, and cost budget.
