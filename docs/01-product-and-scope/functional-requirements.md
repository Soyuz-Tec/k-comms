...
| FR-COM-001 | Provide authorized one-to-one and group audio/video calls with explicit capture controls and screen sharing. | Must | Unified call lifecycle and media kind, source-restricted LiveKit grants, direct draft-to-call promotion with exactly one durable room and an explicit permission-aware prejoin, responsive group grid, screen-share cleanup, durable expiry/eviction, live multi-participant RTP journeys, and [production two-party cellular audio/video qualification](../11-testing-and-quality/external-media-qualification-2026-07-27.md) | Implemented; managed-cloud two-party cellular audio/video qualified; forced TURN/TLS, group-capacity, external screen-share, privacy, outage, and incident gates remain |
| FR-COL-001 | Collaborate on a durable conversation-scoped whiteboard. | Must | Immediate browser-local draft without passive server writes, one-action invite dialog after idempotent Share promotion, workspace-member and active instant-room authorization, bounded Excalidraw scene operations, canonical sequencing, clear/replay, realtime cursor presence, guest scope/abuse denial, multi-device reconciliation, and desktop/mobile browser qualification | Workspace and instant-room application slices implemented; exact-candidate browser, capacity, and production promotion evidence required |
