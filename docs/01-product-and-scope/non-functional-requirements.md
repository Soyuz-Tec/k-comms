...
| NFR-MNT-001 | Maintainability | Material behavior is covered by tests, synchronized contracts, ADRs, formatting, warnings-as-errors, and focused modules. | Backend/web/browser/contract/docs/runner/manifest CI gates | Implemented baseline; automated architecture-boundary enforcement remains pending |
