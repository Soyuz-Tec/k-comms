defmodule CommsCore.AudioCalls do
  ...
  alias CommsCore.{Conversations, Outbox, Repo, RuntimePorts}
  ...
  def list_sessions(subject, params) when is_map(subject) and is_map(params) do
  ...
  def list_sessions(_subject, _params), do: {:error, :forbidden}
